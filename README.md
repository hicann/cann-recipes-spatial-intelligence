...
|[3DGS](algorithms/gaussian_splatting/README.md)|基于3DGS开源加速库，完成其在Atlas A2上的训练和推理适配，并基于NPU特性进行Alpha-blending、视锥剔除、负载均衡、Precise Intersection等优化，实现较低的训推耗时。本样例提供全流程的3DGS训推脚本。
...
│  └── ...
├── algorithms                                  # 算法脚本目录
│  ├─ gaussian_splatting                        # 3DGS算法脚本及执行配置
│  └── ...
├── ops                                         # 自定义融合算子目录
│  ├─ ascendc                                   # 昇腾平台(3DGS)融合算子目录
│  └── ...
