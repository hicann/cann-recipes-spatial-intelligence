function(install_target)
  ...
  set_target_properties(
    ${INSTALL_TARGET_TRG} PROPERTIES LIBRARY_OUTPUT_DIRECTORY
                                     ${meta_gauss_render_PATH}/${INSTALL_TARGET_DST})
...
function(install_file)
  ...
  file(MAKE_DIRECTORY ${meta_gauss_render_PATH}/${INSTALL_TARGET_DST})
    ...
    foreach(bin_script ${bin_scripts})
      ...
      add_custom_target(
        ...
        COMMAND
          ...
          ASCEND_CUSTOM_OPP_PATH=${meta_gauss_render_PATH}/packages/vendors/${vendor_name}
