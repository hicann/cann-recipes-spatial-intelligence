...
2. 本样例的torch以及torch_npu版本为2.6，请从[Ascend Extension for PyTorch插件](https://www.hiascend.com/document/detail/zh/Pytorch/710/configandinstg/instg/insg_0004.html)下载torch与torch_npu安装包
    ```shell
...
- 安装Python依赖
    ...
    ```
- 将Hunyuan3D仓库的网络模型文件以非覆盖模式复制到本项目目录下。
    ```shell
