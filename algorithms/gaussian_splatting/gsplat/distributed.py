# coding=utf-8
# Adapted from
# https://github.com/nerfstudio-project/gsplat/blob/main/gsplat/distributed.py
...
def cli(fn: Callable, args: Any, verbose: bool = False) -> bool:
    ...
    ```python
    # Launch with "ASCEND_RT_VISIBLE_DEVICES=0,1,2,3 python my_script.py"
    if __name__ == "__main__":
        cli(fn, None, verbose=True)
    ```
    """
    if not torch.npu.is_available():
        raise RuntimeError("NPU device is required!")
